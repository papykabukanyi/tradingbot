        ...
        if (newsData && newsData.articles && newsData.articles.length > 0) {
            ...
            const articlesWithSentiment = newsData.articles.map(article => {
                if (!article.sentiment) {
                    ...
                    const positiveWords = ['rise', 'gain', 'bull', 'rally', 'growth', 'positive', 
                                          'upbeat', 'surge', 'soar', 'climb', 'beat', 'exceed', 'record'];
                    const negativeWords = ['fall', 'drop', 'decline', 'bear', 'recession', 'negative',
                                          'plunge', 'tumble', 'slump', 'miss', 'loss', 'concern', 'worry'];
